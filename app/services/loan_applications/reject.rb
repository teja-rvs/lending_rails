  ...
  class Reject < ApplicationService
    ...
    def call
      loan_application.with_lock do
        return blocked_result("This application has already reached a final decision.") unless loan_application.rejectable?

        loan_application.update!(status: "rejected", decision_notes:)
